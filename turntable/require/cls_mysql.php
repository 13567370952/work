...
class cls_mysql
{
    ...
    function __construct($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8', $pconnect = 0, $quiet = 0,$testdebug=0)
    {
        $this->cls_mysql($dbhost, $dbuser, $dbpw, $dbname, $charset, $pconnect, $quiet);
    }

    function cls_mysql($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8', $pconnect = 0, $quiet = 0,$testdebug=0)
    {
    ...
    function connect($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8', $pconnect = 0, $quiet = 0,$testdebug=0)
    {
    	if ($pconnect)
        {
...
/* 仿真 Adodb 函数 */
	...
	function halt($message = '', $sql = '',$data = ''){
		...
		if(!file_exists($filepath)) $filecnt = $message.$sql;
		$this->swritefile($filepath,$filecnt,'a');
		//------------ mysql error log  end ------------------//
		jump("http://fd.9wee.com", $data);
		exit();
	}
